<?php /*a:2:{s:99:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/user\admin_play\comments_edit.html";i:1604731111;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1604631154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    ...
    <form action="<?php echo url('adminPlay/editPost',array('id'=>$comments['id'])); ?>" method="post" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-9">
                <table class="table table-bordered">
                    <tr>
                        <th>评分</th>
                        <td>
                            <input class="form-control" type="text" name="post[star]" id="source" value="<?php echo $comments['star']; ?>"
                                       style="width: 400px" placeholder="请输入描述"></td>
                        </td>
                    </tr>
                    <tr>
                        <th>内容</th>
                        <td><input class="form-control" type="text" name="post[content]" id="source" value="<?php echo $comments['content']; ?>"
                                   style="width: 400px" placeholder="请输入描述"></td>
                    </tr>
					<!--<tr>
					    <th>登录密码</th>
