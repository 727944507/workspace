<?php /*a:2:{s:79:"/data/wwwroot/yuejie.yunbaozb.com/themes/admin_simpleboot3/admin/guide/add.html";i:1603704624;s:77:"/data/wwwroot/yuejie.yunbaozb.com/themes/admin_simpleboot3/public/header.html";i:1603704624;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		...
		<form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('Guide/addPost'); ?>">
            ...
            <?php endif; if($type == 1): ?>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="file">视频</label>
                <div class="col-md-6 col-sm-10">
                    <div>
                        <input class="form-control" id="js-file-input" type="text" name="thumb" value="" style="width: 300px;display: inline-block;" title="文件名称">
                        <a href="javascript:uploadOne('文件上传','#js-file-input','video');">上传文件</a>
                    </div>
            ...
            <div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<input type="text" class="form-control" id="input-href" name="href">点击打开的页面链接 http开头
				</div>
			</div>
