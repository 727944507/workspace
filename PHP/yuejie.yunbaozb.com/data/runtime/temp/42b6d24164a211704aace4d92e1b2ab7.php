...
<body>
    <div class="auth_status">
        ...
        <div class="status_info">
            ...
            <p class="status_info_t no"><?php echo lang('大神技能审核未通过'); ?></p>
            <p class="status_info_d"><?php echo $info['reason']; ?></p>
            <?php else: ?>
            <p class="status_info_t"><?php echo lang('大神技能审核中...'); ?></p>
        ...
        <?php if($info && $info['status'] == 2): ?>
        <div class="autharea">
            <a href="/appapi/skillauth/apply?uid=<?php echo $uid; ?>&token=<?php echo $token; ?>&skillid=<?php echo $skillid; ?>&reset=1"><?php echo lang('重新认证'); ?></a>
        </div>
        <?php endif; ?>
    </div>
