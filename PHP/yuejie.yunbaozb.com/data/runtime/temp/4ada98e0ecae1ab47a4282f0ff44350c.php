<?php /*a:2:{s:87:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/admin\label\index.html";i:1603704624;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1604631154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
            <li><a href="<?php echo url('Skill/index'); ?>">技能列表</a></li>
			<li class="active"><a >列表</a></li>
			<li><a href="<?php echo url('label/add',['skillid'=>$skillid]); ?>">添加</a></li>
		</ul>
        <div class="well">
            <?php echo $info['name']; ?> --标签
        </div>
        
		<form method="post" class="js-ajax-form" action="<?php echo url('label/listOrder'); ?>">
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>	
                            <a class="btn btn-xs btn-primary" href='<?php echo url("label/edit",array("id"=>$vo["id"])); ?>'><?php echo lang('EDIT'); ?></a>
							<a class="btn btn-xs btn-danger js-ajax-delete" href="<?php echo url('label/del',array('id'=>$vo['id'],'skillid'=>$vo['skillid'])); ?>"><?php echo lang('DELETE'); ?></a>
						</td>
					</tr>
