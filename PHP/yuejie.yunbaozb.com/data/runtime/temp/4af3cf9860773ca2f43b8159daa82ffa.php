<?php /*a:2:{s:92:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/admin\slide_item\index.html";i:1603704624;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1603704624;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if(empty($vo['status']) == 1): ?>
                            <a href="<?php echo url('SlideItem/cancelban',array('id'=>$vo['id'],'slide_id'=>$slide_id)); ?>" class="btn btn-xs btn-warning js-ajax-dialog-btn"
                               data-msg="确定显示此幻灯片吗？"><?php echo lang('DISPLAY'); ?></a>
                            <?php else: ?>
                            <a href="<?php echo url('SlideItem/ban',array('id'=>$vo['id'],'slide_id'=>$slide_id)); ?>" class="btn btn-xs btn-warning js-ajax-dialog-btn"
