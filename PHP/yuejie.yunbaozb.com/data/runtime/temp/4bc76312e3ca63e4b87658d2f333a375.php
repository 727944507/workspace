<?php /*a:2:{s:91:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/admin\sysnotice\index.html";i:1603704624;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1604631154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li><a href="<?php echo url('Sysnotice/add'); ?>">添加</a></li>
		</ul>
        
        <form class="well form-inline margin-top-20" method="post" action="<?php echo url('Sysnotice/index'); ?>">
            ...
            <a class="btn btn-danger" href="<?php echo url('Sysnotice/index'); ?>">清空</a>
        </form>
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
                        ...
                        <td>	
							<a class="btn btn-xs btn-danger js-ajax-delete" href="<?php echo url('Sysnotice/del',array('id'=>$vo['id'])); ?>" data-msg="您确定要删除么"><?php echo lang('DELETE'); ?></a>
						</td>
					</tr>
