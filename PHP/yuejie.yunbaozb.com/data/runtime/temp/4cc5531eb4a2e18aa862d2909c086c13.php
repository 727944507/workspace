<?php /*a:2:{s:103:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/admin\manager\dynmanagerylistedit.html";i:1604911624;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1604631154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    ...
    <form action="<?php echo url('dynamic/editPost',array('id'=>$data['id'])); ?>" method="post" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-9">
                <table class="table table-bordered">
                    <tr>
                        <th>点赞数</th>
                        <td>
                            <input class="form-control" type="text" name="post[likes]" id="source" value="<?php echo $data['likes']; ?>"
