<?php /*a:2:{s:90:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/admin\manager\avatar.html";i:1605238844;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1604631154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap">
    ...
    <form class="well form-inline margin-top-20" method="post" action="<?php echo url('admin/manager/avatar'); ?>">
        用户ID：
        ...
        <a class="btn btn-danger" href="<?php echo url('admin/manager/avatar'); ?>">清空</a>
		<br>
        <br>
            ...
            <?php 
             ...
             if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                <tr>
                    ...
                    <td><img class="imgtip" src="<?php echo get_upload_path($vo['avatar']); ?>" style="max-width:100px;"></td>
