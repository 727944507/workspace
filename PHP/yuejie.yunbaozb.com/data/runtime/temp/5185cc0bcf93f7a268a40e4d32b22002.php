<?php /*a:2:{s:94:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/admin\manager\reale_name.html";i:1605257166;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1604631154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
        ...
        <form class="well form-inline margin-top-20" method="post" action="<?php echo url('manager/realeName'); ?>">
            状态：
            ...
            <a class="btn btn-danger" href="<?php echo url('manager/realeName'); ?>">清空</a>
        </form>
            ...
            $('.setstatus').click(function(){
                ...
                layer.prompt({
					...
					yes: function(index, layero){
						...
						if (value) {
							$.ajax({
								url:'<?php echo url('manager/realeNamesetstatus'); ?>',
								type:'POST',
