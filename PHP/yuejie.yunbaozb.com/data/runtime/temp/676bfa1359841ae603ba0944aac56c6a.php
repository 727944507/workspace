<?php /*a:2:{s:88:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/admin\charge\index.html";i:1603704624;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1604631154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
        ...
        <form class="well form-inline margin-top-20"  name="form1"  method="post" action="">
            ...
            <a class="btn btn-danger" href="<?php echo url('Charge/index'); ?>">清空</a>
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>
                            <?php if($vo['status'] == 0): ?>
							<a class="btn btn-xs btn-danger js-ajax-delete" href="<?php echo url('Charge/setPay',array('id'=>$vo['id'])); ?>">确认支付</a>
                            <?php endif; ?>
						</td>
					</tr>
					<?php endforeach; endif; else: echo "" ;endif; ?>
