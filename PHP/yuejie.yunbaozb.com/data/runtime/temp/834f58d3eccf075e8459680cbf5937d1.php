<?php /*a:1:{s:73:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/default/portal\\index.html";i:1603704624;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
...
<title><?php echo (isset($site_info['sitename']) && ($site_info['sitename'] !== '')?$site_info['sitename']:''); ?></title>
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0">
<meta name="keywords" content="短视频"/>
<meta name="description" content="短视频"/>
<link rel="icon" href="/favicon.ico" type="image/x-icon">
<link rel="stylesheet" type="text/css" href="/public/static/index/css/full_index.css" />
	...
	<div class="menu">
		<div class="menu_center">
			<div class="sitename fl">
				<?php echo (isset($site_info['sitename']) && ($site_info['sitename'] !== '')?$site_info['sitename']:''); ?>
			</div>
	...
	<div class="section section1">
		<div class="section_center">
			<div class="section1_left fl">
				<!-- logo -->
				<div class="logo_img">
					<img src="/public/static/index/full_image/logo.png">
				</div>
				<!-- desc -->
				<div class="desc_img">
					<img src="/public/static/index/full_image/desc.png">	
				</div>
				<!-- download  -->
				<div class="download">
					<div class="ewm_area fl">
						...
						<div class="ewm_download">
							<img src="/public/static/index/full_image/ios.png">
						</div>
						<div class="ewm_download ">
							<img src="/public/static/index/full_image/android.png">
						</div>
					</div>
					<div class="ewm_area fr mr_20">
						<div class="ewm_img">
							...
							<?php else: ?>
								<img src="/public/static/index/full_image/ewm.png">
							<?php endif; ?>
						</div>
			...
			<div class="section1_right fr">
				<img src="/public/static/index/full_image/demo1.png">
			</div>
	...
	<div class="section section2">
		<!-- <div class="section22"> -->
			<div class="section2_left fl">
				<img src="/public/static/index/full_image/demo2.png">
			</div>
			<div class="section2_right fl">
				<div class="sel2content">
...
<script type="text/javascript" src="/public/static/index/js/jquery-1.11.1.js"></script>
<script type="text/javascript" src="/public/static/index/js/jquery.fullPage.js"></script>
