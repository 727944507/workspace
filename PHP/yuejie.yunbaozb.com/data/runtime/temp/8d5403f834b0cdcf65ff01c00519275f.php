<?php /*a:2:{s:91:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/admin\skillcoin\index.html";i:1605580094;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1604631154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li><a href="<?php echo url('skillcoin/add'); ?>">添加</a></li>
		</ul>
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo $vo['first_price']; ?></td>
						<td><?php echo $vo['orders']; ?></td>
						<td><?php echo $vo['fee']; ?>%</td>
						<td>	
                            <a class="btn btn-xs btn-primary" href='<?php echo url("skillcoin/edit",array("id"=>$vo["id"])); ?>'><?php echo lang('EDIT'); ?></a>
							<a class="btn btn-xs btn-danger js-ajax-delete" href="<?php echo url('skillcoin/del',array('id'=>$vo['id'])); ?>"><?php echo lang('DELETE'); ?></a>
						</td>
					</tr>
