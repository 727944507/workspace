<?php /*a:2:{s:85:"/data/wwwroot/yuejie.yunbaozb.com/themes/admin_simpleboot3/admin/skilllevel/edit.html";i:1603704624;s:77:"/data/wwwroot/yuejie.yunbaozb.com/themes/admin_simpleboot3/public/header.html";i:1603704624;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li ><a href="<?php echo url('Skilllevel/index',['skillid'=>$data['skillid']]); ?>">列表</a></li>
			<li class="active"><a ><?php echo lang('EDIT'); ?></a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('Skilllevel/editPost'); ?>">
            <div class="form-group">
				<label for="input-levelid" class="col-sm-2 control-label"><span class="form-required">*</span>等级</label>
				<div class="col-md-6 col-sm-10">
					<input type="text" class="form-control" id="input-levelid" name="levelid" value="<?php echo $data['levelid']; ?>"> 正整数
				</div>
			</div>
           ...
           <!--  <div class="form-group">
            ...
            <div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					...
					<input type="hidden" name="skillid" value="<?php echo $data['skillid']; ?>" />
