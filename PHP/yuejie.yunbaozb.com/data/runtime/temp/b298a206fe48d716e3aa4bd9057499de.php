<?php /*a:2:{s:85:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/admin\gift\edit.html";i:1603704624;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1603704624;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		...
		<form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('Gift/editPost'); ?>">
            <div class="form-group">
				...
				<div class="col-md-6 col-sm-10" id="type">
					...
					<label class="radio-inline"><input type="radio" name="type" value="<?php echo $key; ?>" <?php if($key == $data['type']): ?>checked<?php endif; ?>><?php echo $v; ?></label>
            ...
            <div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<input type="text" class="form-control" id="input-name" name="giftname" value="<?php echo $data['giftname']; ?>" style="width:300px;">
				</div>
			</div>
            ...
            <div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<input type="text" class="form-control" id="input-needcoin" name="needcoin" value="<?php echo $data['needcoin']; ?>" style="width:300px;">
				</div>
			</div>
            ...
            <div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<input type="hidden" name="gifticon" id="thumbnail" value="<?php echo $data['gifticon']; ?>">
                    <a href="javascript:uploadOneImage('图片上传','#thumbnail');">
                        <?php if(empty($data['gifticon'])): ?>
                        ...
                        <?php else: ?>
                        <img src="<?php echo cmf_get_image_preview_url($data['gifticon']); ?>"
                             id="thumbnail-preview"
                             style="cursor: pointer;max-width:100px;max-height:100px;"/>
                        <?php endif; ?>
                    </a>
            ...
            <div class="form-group">
				...
				<div class="col-md-6 col-sm-10" id="swftype">
					...
					<label class="radio-inline"><input type="radio" name="swftype" value="<?php echo $key; ?>" <?php if($key == $data['swftype']): ?>checked<?php endif; ?>><?php echo $v; ?></label>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
			</div>
            ...
            <div class="form-group" id="">
				...
				<div class="col-md-6 col-sm-10">
                    <div id="swftype_bd_0" <?php if($data['swftype'] == '1'): ?>style="display:none;"<?php endif; ?>>
                        <input type="hidden" name="gif" id="thumbnail2" value="<?php echo $data['swf']; ?>">
                        <a href="javascript:uploadOneImage('图片上传','#thumbnail2');">
                            <?php if(empty($data['swf']) || $data['swftype'] == '1'): ?>
                            <img src="/public/themes/admin_simpleboot3/public/assets/images/default-thumbnail.png"
                                     id="thumbnail2-preview"
                                     style="cursor: pointer;max-width:100px;max-height:100px;"/>
                            <?php else: ?>
                            <img src="<?php echo cmf_get_image_preview_url($data['swf']); ?>"
                                 id="thumbnail2-preview"
                                 style="cursor: pointer;max-width:100px;max-height:100px;"/>
                            <?php endif; ?>
                        </a>
                    ...
                    <div id="swftype_bd_1" <?php if($data['swftype'] == '0'): ?>style="display:none;"<?php endif; ?>>
                        <input class="form-control" id="js-file-input" type="text" name="svga" value="<?php echo $data['swf']; ?>" style="width: 300px;display: inline-block;" title="文件名称">
            ...
            <div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<input type="text" class="form-control" id="input-swftime" name="swftime" value="<?php echo $data['swftime']; ?>" style="width:300px;">秒 精度：小数点后两位
				</div>
			</div>
    ...
    <script type="text/javascript">
        (function(){
            ...
            $('.btn-cancel-thumbnail2').click(function () {
                $('#thumbnail2-preview').attr('src', '/public/themes/admin_simpleboot3/public/assets/images/default-thumbnail.png');
                $('#thumbnail2').val('');
            });
