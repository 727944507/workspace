<?php /*a:2:{s:91:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/admin\liveapply\index.html";i:1603704624;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1604631154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
        ...
        <form class="well form-inline margin-top-20" method="post" action="<?php echo url('liveapply/index'); ?>">
            状态：
            ...
            <a class="btn btn-danger" href="<?php echo url('liveapply/index'); ?>">清空</a>
        </form>
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
                        ...
                        <td><?php if($vo['uptime']): ?><?php echo date('Y-m-d H:i',$vo['uptime']); ?><?php endif; ?></td>
						<td>
                            <?php if($vo['status'] == 0): ?>
        ...
        $(function(){
            ...
            $('.setstatus').click(function(){
                ...
                layer.prompt({
                    ...
                    $.ajax({
                        url:'<?php echo url('liveapply/setstatus'); ?>',
                        type:'POST',
