<?php /*a:2:{s:88:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/admin\manager\live.html";i:1605236619;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1604631154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
        ...
        <form class="well form-inline margin-top-20" method="post" action="<?php echo url('manager/live'); ?>">
            状态：
            ...
            <a class="btn btn-danger" href="<?php echo url('manager/live'); ?>">清空</a>
        </form>
        ...
        $(function(){
            ...
            $('.setstatus').click(function(){
                ...
                layer.prompt({
                    ...
                    $.ajax({
                        url:'<?php echo url('manager/setLiveStatus'); ?>',
                        type:'POST',
