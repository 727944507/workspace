<?php /*a:2:{s:97:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/admin\manager\complaintlist.html";i:1605254542;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1604631154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<link rel="stylesheet"  type="text/css" href="/public/static/js/layer/theme/default/layer.css"></script>
<body>
	<div class="wrap">
        ...
        <form class="well form-inline margin-top-20" method="post" action="<?php echo url('manager/complaintlist'); ?>">
            状态：
            ...
            <input class="form-control" type="text" name="touid" style="width: 200px;" value="<?php echo input('request.touid'); ?>"
                   placeholder="被举报用户ID">
            动态ID：
            <input class="form-control" type="text" name="did" style="width: 200px;" value="<?php echo input('request.did'); ?>"
                   placeholder="动态ID">
            <input type="submit" class="btn btn-primary" value="搜索"/>
            <a class="btn btn-danger" href="<?php echo url('manager/complaintlist'); ?>">清空</a>
        </form>
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<?php if($vo['status'] == '0'): ?>
								<a class="btn btn-xs btn-primary " href="javascript:void (0)" onclick="setbanorder(<?php echo $vo['touid']; ?>,<?php echo $vo['id']; ?>)" >禁止接单</a>
							<?php endif; ?>
                            <!-- <a class="btn btn-xs btn-danger js-ajax-delete" href="<?php echo url('userrepot/del',array('id'=>$vo['id'])); ?>"><?php echo lang('DELETE'); ?></a> -->
						</td>
					</tr>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
	...
	<script type="text/javascript">
		...
		function setbanorder(touid,reportid){
			layer.open({
				...
				area: ['30%', '26%'],
				btn:['确定','取消'],
				content: '/admin/manager/complaintlistsetbanorder.html&touid='+touid,
				btn1:function(index,layero){
					var selectBanval=$("#_selectBanval").val();
					//设置禁单时间
					$.ajax({
						url: '/admin/manager/complaintlistsetBan.html',
						type: 'POST',
						dataType: 'json',
