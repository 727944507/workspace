<?php /*a:2:{s:92:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/admin\dynamiccom\index.html";i:1604914558;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1604631154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
        ...
        <form class="well form-inline margin-top-20" method="post" action="<?php echo url('dynamiccom/index'); ?>">
			...
			<a class="btn btn-danger" href="<?php echo url('dynamiccom/add',array('did'=>$did)); ?>">添加评论</a>
        </form>
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a class="btn btn-xs btn-primary" style="background-color: #18bc9c;border-color: #18bc9c;" href="javascript:parent.openIframeLayer('<?php echo url('dynamiccom/edit',array('id'=>$vo['id'])); ?>','编辑页面',{});">编辑</a>
                            <a class="btn btn-xs btn-danger js-ajax-delete" href="<?php echo url('dynamiccom/del',array('id'=>$vo['id'])); ?>"><?php echo lang('DELETE'); ?></a>
						</td>
					</tr>
