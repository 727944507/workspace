<?php /*a:2:{s:98:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/admin\giftrecord\votesrecord.html";i:1604114891;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1604631154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a >礼物收益明细</a></li>
		</ul>
		<form class="well form-inline margin-top-20" method="post" action="<?php echo url('Giftrecord/votesrecord'); ?>">
            ...
            <input class="form-control" type="text" name="uid" style="width: 200px;" value="<?php echo input('request.uid'); ?>"
                   placeholder="请输入收礼ID">
			送礼会员：
            <input class="form-control" type="text" name="fromid" style="width: 200px;" value="<?php echo input('request.fromid'); ?>"
                   placeholder="请输入会员ID">
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo $vo['touserinfo']['user_nickname']; ?> (<?php echo $vo['fromid']; ?>)</td>
