<?php /*a:2:{s:95:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/admin\manager\dynamiclist.html";i:1605255132;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1604631154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
        ...
        <form class="well form-inline margin-top-20" method="post" action="<?php echo url('manager/dynamiclist'); ?>">
            状态：
            ...
            <a class="btn btn-danger" href="<?php echo url('manager/dynamiclist'); ?>">清空</a>
        </form>
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>
                            <?php if($vo['status'] == 0): ?>
                                <a class="btn btn-xs btn-success setstatus" href="<?php echo url('manager/dynamiclistsetstatus',array('id'=>$vo['id'],'status'=>1)); ?>">标记处理</a>
                            <?php endif; ?>
                            
                            <a class="btn btn-xs btn-danger js-ajax-delete" href="<?php echo url('manager/dynamiclistdel',array('id'=>$vo['id'])); ?>"><?php echo lang('DELETE'); ?></a>
						</td>
					</tr>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
