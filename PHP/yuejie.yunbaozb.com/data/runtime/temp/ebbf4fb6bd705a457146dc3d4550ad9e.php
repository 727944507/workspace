<?php /*a:2:{s:99:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/admin\manager\dynmanagerylist.html";i:1605258714;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1604631154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
        ...
        <form class="well form-inline margin-top-20" method="post" action="<?php echo url('manager/dynmanagerylist'); ?>">
            <!-- 状态：
            ...
            <a class="btn btn-danger" href="<?php echo url('manager/dynmanagerylist',array('status'=>$status2)); ?>">清空</a>
        </form>
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a class="btn btn-xs btn-primary" style="background-color: #18bc9c;border-color: #18bc9c;" href="javascript:parent.openIframeLayer('<?php echo url('manager/dynmanagerylistedit',array('id'=>$vo['id'])); ?>','编辑页面',{});">编辑</a>
                            <?php if($vo['type'] == 2): ?>
                            ...
                            <?php endif; if($vo['status'] == 0): ?>
                                <a class="btn btn-xs btn-success js-ajax-dialog-btn" href="<?php echo url('manager/dynmanagerylistsetstatus',array('id'=>$vo['id'],'status'=>1)); ?>">同意</a>
                                <a class="btn btn-xs btn-danger js-ajax-dialog-btn" href="<?php echo url('manager/dynmanagerylistsetstatus',array('id'=>$vo['id'],'status'=>-1)); ?>">拒绝</a>
                            ...
                            <a class="btn btn-xs btn-danger js-ajax-delete" href="<?php echo url('manager/dynmanagerylistdel',array('id'=>$vo['id'])); ?>"><?php echo lang('DELETE'); ?></a>
						</td>
					</tr>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
        ...
        $(function(){
            ...
            $('.setrecom').click(function(){
                ...
                layer.prompt({
                    ...
                    $.ajax({
                        url:'<?php echo url('manager/dynmanagerylistsetrecom'); ?>',
                        type:'POST',
            ...
            $('.view').click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.8,
                    area: ['500px', '100%'],
                    content: '<?php echo url('manager/dynmanagerylistsee'); ?>?id='+id
                }); 
