<?php /*a:2:{s:82:"/data/wwwroot/yuejie.yunbaozb.com/themes/admin_simpleboot3/admin/setting/site.html";i:1603704624;s:77:"/data/wwwroot/yuejie.yunbaozb.com/themes/admin_simpleboot3/public/header.html";i:1603704624;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="tab-pane" id="C">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-10">
                                ...
                                <input type="button" class="btn btn-sm btn-cancel-thumbnail" onclick="$('#thumbnail-preview').attr('src','/themes/admin_simpleboot3/public/assets/images/default-thumbnail.png');$('#thumbnail').val('');return false;" value="取消图片"> 首页使用(APP共用下载二维码) 建议尺寸  200 X 200
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
