<?php /*a:2:{s:89:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/admin\manager\skill.html";i:1605233380;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1604631154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a >技能认证</a></li>
		</ul>
        
        <form class="well form-inline margin-top-20" method="post" action="<?php echo url('manager/skill'); ?>">
            状态：
            ...
            <a class="btn btn-danger" href="<?php echo url('manager/skill'); ?>">清空</a>
        </form>
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo $level[$vo['skillid']][$vo['levelid']]['name']; ?></td>
        ...
        $(function(){
            ...
            $('.setstatus').click(function(){
                ...
                layer.prompt({
                    ...
                    $.ajax({
                        url:'<?php echo url('Skillauth/setstatus'); ?>',
                        type:'POST',
