<?php /*a:2:{s:85:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/admin\skill\add.html";i:1604718291;s:83:"D:\phpstudy_pro\WWW\yuejie.yunbaozb.com/themes/admin_simpleboot3/public\header.html";i:1604631154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		...
		<form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('skill/addPost'); ?>">
			...
			<div class="form-group">
				<label for="input-thumb" class="col-sm-2 control-label"><span class="form-required">*</span>栏目封面</label>
				<div class="col-md-6 col-sm-10">
					<input type="hidden" name="thumb2" id="thumbnail2" value="">
			...
			<div class="form-group">
				<label for="input-thumb" class="col-sm-2 control-label"><span class="form-required">*</span>技能示例图</label>
				<div class="col-md-6 col-sm-10">
					<input type="hidden" name="thumb3" id="thumbnail3" value="">
